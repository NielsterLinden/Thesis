...
\input{mainmatter/06_(differential)_attention}

\input{mainmatter/07_model_scaling_and_efficiency}

\part{Synthesis}
\input{mainmatter/08_what_does_not_matter}
\input{mainmatter/09_best_model}
\input{mainmatter/10_conclusion_and_outlook}
