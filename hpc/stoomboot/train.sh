...
mkdir -p "$OUTPUT_DIR"
mv "/data/atlas/users/nterlind/logs/train_${CONDOR_CLUSTER_ID}.out" "${OUTPUT_DIR}/train_${CONDOR_CLUSTER_ID}.out" 2>/dev/null || true
mv "/data/atlas/users/nterlind/logs/train_${CONDOR_CLUSTER_ID}.err" "${OUTPUT_DIR}/train_${CONDOR_CLUSTER_ID}.err" 2>/dev/null || true
mv "/data/atlas/users/nterlind/logs/train_${CONDOR_CLUSTER_ID}.log" "${OUTPUT_DIR}/train_${CONDOR_CLUSTER_ID}.log" 2>/dev/null || true
