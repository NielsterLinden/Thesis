...
class GANEncoder(nn.Module):
    """Stub adversarial encoder for GAN-style AE.

    TODO: implement adversarially regularized encoder in Phase 2.
    """
    ...
    def forward(self, *, tokens_cont: torch.Tensor, tokens_id: torch.Tensor, globals_vec: torch.Tensor) -> torch.Tensor:
        raise NotImplementedError("GANEncoder is a Phase 2 implementation.")
